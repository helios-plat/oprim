...
def test_fisher_rao_gaussian_same_distribution():
    a = {"mean": 0.0, "std": 1.0}
    r = fisher_rao_distance(a, distribution_b=a, distribution_family="univariate_gaussian")
...
def test_fisher_rao_gaussian_different_means():
    a = {"mean": 0.0, "std": 1.0}
    b = {"mean": 1.0, "std": 1.0}
    r = fisher_rao_distance(a, distribution_b=b, distribution_family="univariate_gaussian")
    assert r["distance"] > 0
...
def test_fisher_rao_gaussian_symmetric():
    a = {"mean": 0.0, "std": 1.0}
    b = {"mean": 2.0, "std": 0.5}
    r1 = fisher_rao_distance(a, distribution_b=b, distribution_family="univariate_gaussian")
    r2 = fisher_rao_distance(b, distribution_b=a, distribution_family="univariate_gaussian")
...
def test_fisher_rao_categorical_same():
    ...
    r = fisher_rao_distance(a, distribution_b=a, distribution_family="categorical")
    assert abs(r["distance"]) < 1e-10
...
def test_fisher_rao_categorical_opposite():
    ...
    r = fisher_rao_distance(a, distribution_b=b, distribution_family="categorical")
...
def test_fisher_rao_multivariate_same():
    ...
    r = fisher_rao_distance(a, distribution_b=a, distribution_family="multivariate_gaussian")
    assert abs(r["distance"]) < 1e-10
...
def test_fisher_rao_multivariate_positive():
    ...
    r = fisher_rao_distance(a, distribution_b=b, distribution_family="multivariate_gaussian")
    assert r["distance"] > 0
...
def test_fisher_rao_invalid_std_raises():
    ...
    with pytest.raises(ValueError):
        fisher_rao_distance(a, distribution_b=b, distribution_family="univariate_gaussian")
...
def test_fisher_rao_invalid_probs_raises():
    ...
    with pytest.raises(ValueError):
        fisher_rao_distance(a, distribution_b=b, distribution_family="categorical")
...
def test_fisher_rao_unsupported_family_raises():
    ...
    with pytest.raises(NotImplementedError):
        fisher_rao_distance(a, distribution_b=a, distribution_family="weibull")
...
def test_fisher_rao_multivariate_dim_mismatch_raises():
    ...
    with pytest.raises(ValueError):
        fisher_rao_distance(a, distribution_b=b, distribution_family="multivariate_gaussian")
