...
class TestHawkesNll:
    ...
    def test_returns_float(self):
        ...
        result = hawkes_nll(self._default_params(), event_times=events, t=5.0)
    ...
    def test_nll_decreases_with_better_fit(self):
        ...
        nll_good = hawkes_nll(good_params, event_times=events, t=t_val)
        nll_bad = hawkes_nll(bad_params, event_times=events, t=t_val)
    ...
    def test_nll_depends_on_t(self):
        ...
        nll5 = hawkes_nll(p, event_times=events, t=5.0)
        nll10 = hawkes_nll(p, event_times=events, t=10.0)
        assert nll5 != nll10
    ...
    def test_a_recursive_accumulation(self):
        ...
        result = hawkes_nll(params, event_times=events, t=t_val)
        assert np.isfinite(result)
    ...
    def test_log_params_ensure_positivity(self):
        ...
        result = hawkes_nll(params, event_times=events, t=3.0)
